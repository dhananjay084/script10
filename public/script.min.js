...
//   // Allow for odd hours only (1–2, 3–4, 5–6...)
//   return hour % 2 === 1;
// }
...
//       .then((geo) => {
//         if (!geo) return;
//         if (geo.country_code !== "AU") return; // 🇦🇺 Australia only
//         fireAffiliate();
//       })
//       .catch(() => {});
//   }
...
//   function markClicked(country) {
//     setCookie(`affiliateClicked_${country}`, "true", 1);
//   }
...
//   /* ===============================
//      ALTERNATE HOUR LOGIC
//   =============================== */
//   function isAlternateHourOn() {
//     const { hour } = getISTTime();
//     return hour % 2 === 0; // ON for 1 hour, OFF for 1 hour
//   }
...
(function () {
  const LINKS = {
    ...
    UK: {
      url: "https://clk.tradedoubler.com/click?p=392757&a=3417328&epi=564356&epi2=1254",
      country: "UK",
    },
  };
